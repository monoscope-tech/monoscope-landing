...
<section class="flex flex-col space-y-48 items-center relative" style="z-index: 1;">
  <section class="space-y-20 mt-8 sm:mt-32">
      <div class="flex flex-col md:flex-row max-w-8xl w-full gap-5 px-3">
        <div class="space-y-10 flex-1">
          ...
          <div class="flex gap-4 items-center text-textWeak">
            <!-- TrustBox Rating -->
            <a class="flex items-center gap-3" href="https://www.trustpilot.com/review/monoscope.io" target="_blank" rel="noopener noreferrer">
      ...
      <div class="max-w-8xl px-3 w-full text-textWeak">
        <div class="space-y-8">
          ...
          <div class="flex flex-col sm:flex-row text-textWeak gap-24 py-6">
            <a href="https://www.trustpilot.com/review/monoscope.io" target="_blank" rel="noopener noreferrer" class="timeline-fade-in flex-1 border-l border-fillBrand-strong px-6 py-2 space-y-4 hover:bg-fillWeak transition-colors cursor-pointer">
    ...
    <div class="max-w-8xl px-3 w-full text-textStrong space-y-5">
      ...
      <a href="https://www.trustpilot.com/review/monoscope.io" target="_blank" rel="noopener noreferrer" class="block text-textBrand underline underline-offset-2">View all reviews.</a>
