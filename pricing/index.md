...
faqs:
  ...
  - q: How does pricing scale with usage?
    a: After the free tier, you pay $29/month for up to 20M events, then $1 per million events after that. For example, 50M events/month costs $59 ($29 base + $30 for 30M extra events). With Cloud + S3, it's $199/month for up to 100M events, then $1 per million events after that, plus you get unlimited data retention.
